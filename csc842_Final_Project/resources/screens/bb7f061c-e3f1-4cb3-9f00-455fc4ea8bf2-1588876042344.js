jQuery("#simulation")
  .on("click", ".s-bb7f061c-e3f1-4cb3-9f00-455fc4ea8bf2 .click", function(event, data) {
  ...
  .on("pageload", ".s-bb7f061c-e3f1-4cb3-9f00-455fc4ea8bf2 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
