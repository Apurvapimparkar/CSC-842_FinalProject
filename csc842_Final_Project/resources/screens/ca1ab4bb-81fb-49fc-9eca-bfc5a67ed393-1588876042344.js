jQuery("#simulation")
  .on("click", ".s-ca1ab4bb-81fb-49fc-9eca-bfc5a67ed393 .click", function(event, data) {
  ...
  .on("pageload", ".s-ca1ab4bb-81fb-49fc-9eca-bfc5a67ed393 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
